...
from utils.delta_tokenizer import DeltaTrajectoryTokenizer
from utils.pai_utils import PhysicalAIAVDatasetLocalInterface
from utils.load_physical_aiavdataset import load_physical_aiavdataset
...
class AlpamayoDemoDataset(Dataset):
    def __init__(
        ...
        self.history_tokenizer = DeltaTrajectoryTokenizer()
...
if __name__ == "__main__":
    ...
    # need expanded tokenizer config for alpamayo
